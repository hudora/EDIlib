"""Functionality for basic parsing of Strated ORDERS data.

Created by Maximillian Dornseif 2008-08-12."""

import unittest
from recordbased import generate_field_datensatz_class, FixedField, DecimalField, IntegerField
from recordbased import DateField, EanField
...
class BelegsummenHandler(object):
    ...
    def validate(self, previousparsers):
        ...
        if summe != self.parser.gesammtbetrag:
            raise MalformedFileException("sums do not validate %r: %r" % (self.parser, previousparsers))
...
class ParsingTestsuite(unittest.TestCase):
    ...
    def test_basic(self):
        ...
        data = '''1003101586145    ORDERSD  96AUNEAN0082209  3101586145                         20080415                                       
119BY 4306544000008TOYS R US GERMANY                                                                                                                                                                                                                                                                                                                                                                                                                               HORT                                                        
119IV 4306544000008                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            
119DP 43065440310193101-HARBKE                                                                                              AM GLUESIG 5                                                                                                      HARBKE                                                                   3101                                                                                                                                                                                                    
119SU 4005998000007HUDORA GMBH                                                                                                                                                                                                                                                                                         24369                                                                                                                                       HR. LUDWIG                                                  
120EUR                        DDP                                                                               
130AAIAchtung!! Auftragskopie des Originalauftrages - EDI                                                                                                                                                                                                                                                                                                           
130AAIIN ABAENDERUNG VON PUNKT IX,1.ABSATZ,SATZ 2 DER UMSEITIG ABGEDRUCKTEN ALLGEMEINEN EINKAUFSBEDINGUNGEN GELTEN DIE GESETZLICHENGEWAEHRLEISTUNGSFRISTEN.                                                                                                                                                                                                         
130AAILIEFERUNG ERFOLGT: FREI HAUS, VERSICHERT UND VERSTEUERT                                                                                                                                                                                                                                                                                                       
130AAIALLE TRANSPORTE MUESSEN DEN RAHMENBEDINGUNGEN FUER DEN WARENVERKEHR MIT TOYS'R'US, NEUESTE AUSGABE, ENTSPRECHEN.                                                                                                                                                                                                                                              
130AAIDIE NICHTBEACHTUNG DER RAHMENBEDINGUNGEN KANN ZUR ANNAHME VERWEIGERUNG DER WARE FUEHREN. ALLE KOSTEN, DIE DURCH DIE NICHTBEACHTUNG ENTSTEHEN, TRAEGT DER HERSTELLER.                                                                                                                                                                                          
140       3.0000                                                                         60        
500     1   400599871590171590TR                            165816                                                                BASKETBALL GROESSE 3 STATS                                                                                                                           180.00                                1.4300                                                                     PCE                                                      CT           6
515        2008092820081004                                                                            
900            257.40
913A  GRB            1.00                                                                  EXPANSIONS BONUS                   
913A  RCH            1.00                                                                  DEFEKTENVERGUETUNG                 
'''
