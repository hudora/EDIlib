...
FELDERA1 = [
 ...
 dict(length=16, startpos=188, endpos=203, name='Skontofähig USt 2',
            fieldclass=DecimalFieldNoDotSigned, precision=3),
 dict(length=3, startpos=204, endpos=206, name='skontotage1'),
 ...
 dict(length=16, startpos=228, endpos=243, name='Skontobetrag 1 USt 2',
            fieldclass=DecimalFieldNoDotSigned, precision=3),
 dict(length=3, startpos=244, endpos=246, name='Skontotage 2'),
...
FELDERA4_ALT = [
    ...
    dict(length=15, startpos=21, endpos=35, name='positionsrabatt1p'),
    dict(length=1, startpos=36, endpos=36, name='rabattkennzeichen1'),
    dict(length=15, startpos=37, endpos=51, name='rabattbetrag1',
        fieldclass=DecimalFieldNoDot, precision=3),
    dict(length=1, startpos=52, endpos=52, name='Vorzeichen Rabatt 1'),
    dict(length=3, startpos=53, endpos=55, name='textschluessel1'),
    dict(length=15, startpos=56, endpos=70, name='positionsrabatt2p'),
    dict(length=1, startpos=71, endpos=71, name='rabattkennzeichen2'),
    dict(length=15, startpos=72, endpos=86, name='rabattbetrag2'),
    dict(length=1, startpos=87, endpos=87, name='Vorzeichen Rabatt 2'),
    dict(length=3, startpos=88, endpos=90, name='textschluessel2'),
    dict(length=15, startpos=91, endpos=105, name='positionsrabatt3p'),
    dict(length=1, startpos=106, endpos=106, name='rabattkennzeichen3'),
    dict(length=15, startpos=107, endpos=121, name='rabattbetrag3'),
    dict(length=1, startpos=122, endpos=122, name='Vorzeichen Rabatt 3'),
    dict(length=3, startpos=123, endpos=125, name='textschluessel3'),
    dict(length=15, startpos=126, endpos=140, name='positionsrabatt4p'),
    dict(length=1, startpos=141, endpos=141, name='rabattkennzeichen4'),
    dict(length=15, startpos=142, endpos=156, name='rabattbetrag4'),
    dict(length=1, startpos=157, endpos=157, name='Vorzeichen Rabatt 4'),
    dict(length=3, startpos=158, endpos=160, name='textschluessel4'),
    dict(length=15, startpos=161, endpos=175, name='positionsrabatt5p'),
    dict(length=1, startpos=176, endpos=176, name='rabattkennzeichen5'),
    dict(length=15, startpos=177, endpos=191, name='rabattbetrag5'),
    dict(length=1, startpos=192, endpos=192, name='Vorzeichen Rabatt 5'),
    dict(length=3, startpos=193, endpos=195, name='textschluessel5'),
    dict(length=15, startpos=196, endpos=210, name='positionsrabatt6p'),
    dict(length=1, startpos=211, endpos=211, name='rabattkennzeichen6'),
    dict(length=15, startpos=212, endpos=226, name='rabattbetrag6'),
    dict(length=1, startpos=227, endpos=227, name='Vorzeichen Rabatt 6'),
    dict(length=3, startpos=228, endpos=230, name='textschluessel6'),
    dict(length=15, startpos=231, endpos=245, name='positionsrabatt7p'),
    dict(length=1, startpos=246, endpos=246, name='rabattkennzeichen7'),
    dict(length=15, startpos=247, endpos=261, name='rabattbetrag7'),
    dict(length=1, startpos=262, endpos=262, name='Vorzeichen Rabatt 7'),
    dict(length=3, startpos=263, endpos=265, name='textschluessel7'),
    dict(length=15, startpos=266, endpos=280, name='positionsrabatt8p'),
    dict(length=1, startpos=281, endpos=281, name='rabattkennzeichen8'),
    dict(length=15, startpos=282, endpos=296, name='rabattbetrag8'),
    dict(length=1, startpos=297, endpos=297, name='Vorzeichen Rabatt 8'),
    dict(length=3, startpos=298, endpos=300, name='textschluessel8'),
