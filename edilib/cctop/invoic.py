...
ZUSATZKOSTEN140 = [
    ...
    dict(startpos=35, endpos=52, length=18, name='frachtbetrag', fieldclass=DecimalField, precision=2,
         doc="MOA20-5004"),
...
RECHNUNGSPOSITION500 = [
    ...
    dict(startpos=339, endpos=353, length=15, name='verkaufspreis', fieldclass=DecimalField, precision=2,
        doc="PRI-5118"),
